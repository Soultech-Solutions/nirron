...
export const importsMockList: ImportListItemDto[] = [
  {
    ...
    emailSubject: 'Invoice LG Display — COM 2026',
  ...
  },
  {
    ...
    emailId: 'b2c3d4e5-f6a7-8901-bcde-f12345678901',
    emailSubject: 'Samsung SDS — docs importação',
  ...
  },
  {
    ...
    emailSubject: 'Foxconn — packing list + BL',
  ...
  },
  {
    ...
    emailId: 'd4e5f6a7-b8c9-0123-def0-234567890123',
    emailSubject: 'Multilaser — DUIMP docs',
